...
## read in trait data 
effect_traits <- read.csv("../Data/Trait data/Seed dispersal/seed_effect_traits.csv", header=TRUE)
response_traits <- read.csv("../Data/Trait data/Seed dispersal/seed_response_traits.csv", header=TRUE)
effect_both_traits <- read.csv("../Data/Trait data/Seed dispersal/seed_effect_both_traits.csv", header=TRUE)
response_both_traits <- read.csv("../Data/Trait data/Seed dispersal/seed_response_both_traits.csv", header=TRUE)
all_traits <- read.csv("../Data/Trait data/Seed dispersal/seed_all_traits.csv", header=TRUE)
BBS_data <- read.csv("../Data/Analysis_data/Seed dispersal/BBS_2004_2018_seed.csv", header=TRUE)
