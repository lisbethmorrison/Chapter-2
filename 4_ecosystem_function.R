...
## add data
BBS_final <- read.csv("../Data/BBS_abund_data/BBS_2004_2018.csv", header=TRUE)
effect <- read.csv("../Data/Analysis_data/Seed dispersal/seed_effect_traits.csv", header=TRUE) ## 32 spp
response <- read.csv("../Data/Analysis_data/Seed dispersal/seed_response_traits.csv", header=TRUE) ## 38 spp
all_traits <- read.csv("../Data/Analysis_data/Seed dispersal/seed_all_traits.csv", header=TRUE) ## 28 spp
